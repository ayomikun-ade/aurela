...
export default function Navbar() {
  return (
    <motion.header
      ...
      className="text-primary font-quicksand flex justify-between items-center max-w-[1200px] h-[72px] px-6 mx-auto"
    >
      ...
      <nav className="flex gap-32 max-md:hidden">
        <ul className="flex gap-8 items-center font-semibold">
          ...
          <a href="/about" className="cursor-pointer hover:opacity-65">
            About
          </a>
          <a href="#" className="cursor-pointer hover:opacity-65">
            Shop
